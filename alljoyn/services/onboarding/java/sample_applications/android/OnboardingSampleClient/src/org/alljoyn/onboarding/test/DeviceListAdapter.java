...
/**
 * This class implements a list adapter in order to display the list of all the
 * devices we are announced on.
 */
    ...
    public void addDevice(SoftAPDetails newDevice) {
        ...
        for (int i = 0; i < m_properties.size(); i++) {
            ...
            if (oldDevice.appId.equals(newDevice.appId)) {
                ...
                // We already have this device in the list. so update its
                // values.
                found = true;
                ...
                oldDevice.objectDescriptions = newDevice.objectDescriptions;
